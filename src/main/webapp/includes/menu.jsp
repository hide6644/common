...
<sec:authorize access="hasRole('ROLE_ADMIN')">
                <li class="dropdown<c:if test="${currentMenu eq 'admin'}"> active</c:if>">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<c:url value="/admin/master/top" />"><fmt:message key="admin.master.topForm" /></a></li>
                        <li><a href="<c:url value="/admin/activeUsers" />"><fmt:message key="activeUsersForm" /></a></li>
                    </ul>
                </li>
</sec:authorize>
<sec:authorize access="isAuthenticated()">
                <li><a href="<c:url value="/logout" />"><fmt:message key="topForm.logout" /></a></li>
</sec:authorize>
            </ul>
        </div>
